import type {
  ...
  DesignHostListInput,
  DesignHostListOutput,
  DesignHostOpenInput,
  DesignHostOpenOutput,
  DesignHostLaunchInput,
  DesignHostLaunchOutput,
  DesignHostReleaseInput,
  DesignHostReleaseOutput,
  DesignHostFeedInput,
  DesignHostFeedOutput,
  DesignHostFeedbackInput,
  DesignHostFeedbackOutput,
  DesignHostApproveInput,
  DesignHostApproveOutput,
  DesignHostPermissionInput,
  DesignHostPermissionOutput,
  MessagesListInput,
  MessagesListOutput,
  ModelsListInput,
  ModelsListOutput,
...
export function make(options: ClientOptions) {
  ...
  return {
        ...
        request<SessionsV2PromptOutput>(
          {
            ...
            successStatus: 200,
            declaredStatuses: [400, 404, 409, 401],
            empty: false,
          },
          requestOptions,
        ),
    ...
    designHost: {
      list: (input: DesignHostListInput, requestOptions?: RequestOptions) =>
        request<DesignHostListOutput>(
          {
            method: "GET",
            path: `/api/design/list`,
            query: { directory: input["directory"] },
            successStatus: 200,
            declaredStatuses: [403, 401, 400],
            empty: false,
          },
          requestOptions,
        ),
      open: (input: DesignHostOpenInput, requestOptions?: RequestOptions) =>
        request<DesignHostOpenOutput>(
          {
            method: "GET",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/open`,
            successStatus: 200,
            declaredStatuses: [409, 403, 400, 404, 401],
            empty: false,
          },
          requestOptions,
        ),
      launch: (input: DesignHostLaunchInput, requestOptions?: RequestOptions) =>
        request<DesignHostLaunchOutput>(
          {
            method: "POST",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/launch`,
            body: { explicit: input["explicit"] },
            successStatus: 200,
            declaredStatuses: [409, 403, 400, 404, 401],
            empty: false,
          },
      ...
      release: (input: DesignHostReleaseInput, requestOptions?: RequestOptions) =>
        request<DesignHostReleaseOutput>(
          {
            method: "POST",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/launch/release`,
      ...
      feed: (input: DesignHostFeedInput, requestOptions?: RequestOptions): AsyncIterable<DesignHostFeedOutput> =>
        sse<DesignHostFeedOutput>(
          {
            method: "GET",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/feed`,
            query: { after: input["after"] },
            successStatus: 200,
            declaredStatuses: [409, 403, 400, 404, 401],
            empty: false,
      ...
      feedback: (input: DesignHostFeedbackInput, requestOptions?: RequestOptions) =>
        request<DesignHostFeedbackOutput>(
          {
            method: "POST",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/${encodeURIComponent(input.designID)}/feedback`,
            body: {
              action: input["action"],
              params: input["params"],
              id: input["id"],
      ...
      approve: (input: DesignHostApproveInput, requestOptions?: RequestOptions) =>
        request<DesignHostApproveOutput>(
          {
            method: "POST",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/${encodeURIComponent(input.designID)}/approve`,
            body: { revision: input["revision"], variant: input["variant"] },
            successStatus: 200,
            declaredStatuses: [409, 403, 400, 404, 401],
            empty: false,
      ...
      permission: (input: DesignHostPermissionInput, requestOptions?: RequestOptions) =>
        request<DesignHostPermissionOutput>(
          {
            method: "POST",
            path: `/api/design/session/${encodeURIComponent(input.sessionID)}/permission`,
            body: {

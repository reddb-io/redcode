...
export type SessionsHistoryOutput = {
  readonly data: ReadonlyArray<
    ...
    | {
        readonly id: string
        readonly metadata?: { readonly [x: string]: JsonValue }
        readonly type: "session.next.prompt.delivery"
        readonly durable?: { readonly aggregateID: string; readonly seq: number; readonly version: number }
        readonly location?: { readonly directory: string; readonly workspaceID?: string }
        readonly data: {
          readonly timestamp: number
...
export type DesignsListOutput = ReadonlyArray<{
  ...
  readonly rounds?: ReadonlyArray<{
    ...
    readonly opened: number | "Infinity" | "-Infinity" | "NaN"
    readonly revision: string
...
export type SessionsV2PromptOutput = {
  readonly admittedSeq: number
  readonly id: string
  readonly sessionID: string
  readonly prompt: {
...
export type SessionsV2SessionInput = { readonly id: { readonly id: string }["id"] }

export type SessionsV2SessionOutput = {
  readonly id: string
  readonly parentID?: string
  readonly projectID: string
  readonly agent?: string
...
export type SessionsV2MessagesInput = { readonly id: { readonly id: string }["id"] }

export type SessionsV2MessagesOutput = ReadonlyArray<
  | {
      readonly id: string
      readonly metadata?: { readonly [x: string]: JsonValue }
      readonly time: { readonly created: number }
...
export type SessionsV2EventsInput = {
  readonly id: { readonly id: string }["id"]
  readonly after?: { readonly after?: number | undefined }["after"]
}

export type SessionsV2EventsOutput = ReadonlyArray<
  | {
      readonly id: string
      readonly metadata?: { readonly [x: string]: JsonValue }
      readonly type: "session.next.agent.switched"

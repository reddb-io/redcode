...
import { compile, emitEffectImported, emitPromise, write } from "@reddb-io/redcode-httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "RedcodeEventEncoded",
              import: 'import type { RedcodeEventEncoded } from "@reddb-io/redcode-protocol/groups/event"',
            },
          },
        }),

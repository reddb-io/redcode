...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@redcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@redcode/ACPDirectory") {}

...
import type { Message } from "@reddb-io/redcode-sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@reddb-io/redcode-core/effect/app-node"
...
type RedcodeAssistantMessage = import("@reddb-io/redcode-sdk/v2").AssistantMessage

export type AssistantTokenCost = Pick<RedcodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<RedcodeAssistantMessage, "role"> &
  Partial<Pick<RedcodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@redcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@redcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@redcode/ACPUsage") {}

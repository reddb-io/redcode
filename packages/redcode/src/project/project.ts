...
import { ProjectDirectoryTable, ProjectTable } from "@reddb-io/redcode-core/project/sql"
import { ProjectDirectories } from "@reddb-io/redcode-core/project/directories"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.REDCODE_FAKE_VCS)

...
import { AccountStateTable, AccountTable } from "@reddb-io/redcode-core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/AccountRepo") {}

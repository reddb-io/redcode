...
import { path } from "@reddb-io/redcode-core/effect/app-node-platform"
...
import type { ProjectV2 } from "@reddb-io/redcode-core/project"
...
import { WorktreeEvent } from "@reddb-io/redcode-schema/worktree-event"
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `redcode/${name}`

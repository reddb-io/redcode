 ...
 *   "@redcode/ServerAuthConfig",
 *   {
 *     password: Config.string("REDCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("REDCODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *

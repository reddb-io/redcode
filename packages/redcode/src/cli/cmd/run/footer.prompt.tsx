...
import { normalizePromptContent } from "@reddb-io/redcode-tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@reddb-io/redcode-tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Redcode" } satisfies SlashOption,
    ]

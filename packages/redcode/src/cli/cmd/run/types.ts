...
import type { PermissionRequest, QuestionRequest, RedcodeClient, ToolPart } from "@reddb-io/redcode-sdk/v2"
import type { TuiConfig } from "@reddb-io/redcode-tui/config"
...
type PromptModel = Parameters<RedcodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<RedcodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<RedcodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<RedcodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<RedcodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<RedcodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<RedcodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<RedcodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<RedcodeClient["question"]["reject"]>[0]

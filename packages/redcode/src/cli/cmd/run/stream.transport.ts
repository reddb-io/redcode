...
import type { Event, GlobalEvent, RedcodeClient } from "@reddb-io/redcode-sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@redcode/RunStreamTransport") {}

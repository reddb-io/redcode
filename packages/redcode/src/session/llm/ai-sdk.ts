...
// Move this extraction into @reddb-io/redcode-llm when Copilot is handled by the native runtime.
...
export function toLLMEvents(
  ...
  switch (event.type) {
    ...
    case "finish-step":
      // Gateways end a stream cleanly with this finish reason when their upstream drops. Read
      // as a normal step finish it produced a silently truncated answer — half a tool call and
      // no error. Failing here is what lets the retry layer see it.

...
import { EventSequenceTable, EventTable } from "@reddb-io/redcode-core/event/sql"
import { FSUtil } from "@reddb-io/redcode-core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@reddb-io/redcode-core/project"
import { Slug } from "@reddb-io/redcode-core/util/slug"
...
import { WorkspaceEvent } from "@reddb-io/redcode-schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        REDCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        REDCODE_WORKSPACE_ID: config.id,
        REDCODE_EXPERIMENTAL_WORKSPACES: "true",

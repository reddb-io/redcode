import type { Hooks, PluginInput } from "@reddb-io/redcode-plugin"
import type { Model } from "@reddb-io/redcode-sdk/v2"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Redcode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",

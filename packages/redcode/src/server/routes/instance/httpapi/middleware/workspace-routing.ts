...
>()("@redcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@redcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.REDCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.REDCODE_WORKSPACE_ID) : undefined
}

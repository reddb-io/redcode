...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders REDCODE_CALLER", () => {
    process.env["REDCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode REDCODE_CALLER", () => {
    process.env["REDCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown REDCODE_CALLER", () => {
    process.env["REDCODE_CALLER"] = "unknown"

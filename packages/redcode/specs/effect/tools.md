...
Practical reference for the current tool-migration state in `packages/redcode`.
...
Tool tests should use the existing Effect helpers in `packages/redcode/test/lib/effect.ts`:

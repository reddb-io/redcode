...
The Promise plugin API is the async/await equivalent of `@reddb-io/redcode-plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@reddb-io/redcode-plugin/v2/promise"

...
- Effect plugins import `@reddb-io/redcode-plugin/v2/effect`, not `@reddb-io/redcode-core`.
- Public domain values use generated `@reddb-io/redcode-sdk` types.
...
- Define `PluginHost` domain capabilities in `@reddb-io/redcode-plugin/v2/effect`.

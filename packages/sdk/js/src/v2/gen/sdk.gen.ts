...
import type {
  ...
  V2SessionEvents2Errors,
  V2SessionEvents2Responses,
  ...
  V2SessionInterrupt2Errors,
  V2SessionInterrupt2Responses,
  ...
  V2SessionPrompt2Errors,
  V2SessionPrompt2Responses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new RedcodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Redcode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Redcode system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Redcode server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Redcode state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Redcode configuration settings and preferences.
   */
   ...
   *
   * Update global Redcode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Redcode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Redcode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Redcode instances, releasing all resources.
   */
   ...
   * Upgrade Redcode
   *
   * Upgrade Redcode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Redcode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Redcode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Redcode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Redcode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Redcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Redcode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Redcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Redcode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Redcode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Redcode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Redcode process. Idle interruption is a no-op.
   */
  ...
  public prompt2<ThrowOnError extends boolean = false>(
    parameters?: {
      sessionV2PromptPayload?: SessionV2PromptPayload
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams([parameters], [{ args: [{ key: "sessionV2PromptPayload", map: "body" }] }])
    return (options?.client ?? this.client).post<V2SessionPrompt2Responses, V2SessionPrompt2Errors, ThrowOnError>({
  ...
  public read<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<V2SessionReadResponses, V2SessionReadErrors, ThrowOnError>({
   ...
   */
  public events2<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
      after?: string
    },
    ...
    return (options?.client ?? this.client).get<V2SessionEvents2Responses, V2SessionEvents2Errors, ThrowOnError>({
   ...
   */
  public interrupt2<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
    },
    options?: Options<never, ThrowOnError>,
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "path", key: "id" }] }])
    return (options?.client ?? this.client).post<V2SessionInterrupt2Responses, V2SessionInterrupt2Errors, ThrowOnError>(
      {
...
export class RedcodeClient extends HeyApiClient {
  ...
  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    RedcodeClient.__registry.set(this, args?.key)
  }

...
```json title="opencode.json"
{
  ...
  "experimental": {
    ...
    "tool_timeout": 600000,
    "loop_guard": { "correct_at": 3, "stop_at": 5, "nudge_at": 12, "failure_stop_at": 8 },

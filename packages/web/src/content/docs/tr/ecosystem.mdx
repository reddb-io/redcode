...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @reddb-io/redcode-sdk aracılığıyla OpenCode kullanmak için Vercel AI SDK sağlayıcısı |

...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: RedcodeClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  scope: ServerScope,
  serverSDK: () => RedcodeClient,
  serverAPI: ServerApi,
  sdkFor: (dir: PathKey) => RedcodeClient,
  protocol: Promise<"v1" | "v2">,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, RedcodeClient>()

...
import type { RedcodeClient } from "@reddb-io/redcode-sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: RedcodeClient; directory: string; limit: number }) {
  try {

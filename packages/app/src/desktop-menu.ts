...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      { type: "item", labelKey: "desktop.menu.documentation", href: "https://github.com/reddb-io/redcode" },
      { type: "item", labelKey: "desktop.menu.supportForum", href: "https://github.com/reddb-io/redcode/discussions" },
      { type: "item", labelKey: "desktop.menu.exportLogs", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        labelKey: "desktop.menu.shareFeedback",
        href: "https://github.com/reddb-io/redcode/issues/new?template=feature-request.yml",
      },
      {
        type: "item",
        labelKey: "desktop.menu.reportBug",
        href: "https://github.com/reddb-io/redcode/issues/new?template=bug-report.yml",
      },
    ],
  },
]

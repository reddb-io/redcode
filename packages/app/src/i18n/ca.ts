...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Redcode.",
  ...
  "desktop.recovery.loadFailed": "Redcode no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Redcode s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Redcode no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de Redcode ha fallat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcode actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Redcode",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Autoritza {{name}}",
  "mcp.auth.browserBlocked.description": "No s'ha pogut obrir un navegador. Obre aquest URL per autoritzar: {{url}}",
  "mcp.auth.browserBlocked.open": "Obre l'URL",
  "mcp.auth.browserBlocked.copy": "Copia l'URL",
  ...
  "dialog.server.description": "Canvia a quin Redcode servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant Redcode a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant Redcode a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza Redcode a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu Redcode a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Redcode pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Redcode no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Redcode.",
  ...
  "help.tabs.introduction": "Redcode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Redcode ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Redcode.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Redcode encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Redcode Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Redcode dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Redcode",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Redcode al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Redcode segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Redcode.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Redcode.",

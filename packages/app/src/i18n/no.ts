...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Redcode-meny",
  ...
  "desktop.recovery.loadFailed": "Redcode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Redcode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Redcode svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Redcode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Redcode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Redcode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Redcode.",
  ...
  "dialog.server.description": "Bytt hvilken Redcode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Redcode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Redcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Redcode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Redcode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Redcode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Redcode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Redcode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Redcode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Redcode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Redcode starter",
  ...
  "settings.updates.toast.latest.title": "Redcode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Redcode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Redcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Redcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Redcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Redcode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Redcode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Redcode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Redcode på nytt.",
  ...
  "help.tabs.introduction": "Redcode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":

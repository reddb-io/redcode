...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Redcode",
  ...
  "desktop.recovery.loadFailed": "Redcode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Redcode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Redcode ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Redcode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Redcode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Redcode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Redcode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Redcode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Redcode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Redcode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Redcode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Redcode u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Redcode u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Redcode u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Redcode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Redcode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Redcode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Redcode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Redcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Redcode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Redcode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Redcode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Redcode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Redcode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Redcode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Redcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Redcode-a.",

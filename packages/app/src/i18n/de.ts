...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Redcode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Redcode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Redcode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Redcode zu nutzen.",
  ...
  "mcp.auth.browserBlocked.title": "{{name}} autorisieren",
  "mcp.auth.browserBlocked.description":
    "Browser konnte nicht geöffnet werden. Öffne diese URL zur Autorisierung: {{url}}",
  "mcp.auth.browserBlocked.open": "URL öffnen",
  "mcp.auth.browserBlocked.copy": "URL kopieren",
  ...
  "dialog.server.description": "Wechseln Sie den Redcode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Redcode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Redcode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Redcode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Redcode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Redcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Redcode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Redcode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Redcode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Redcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Redcode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Redcode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Redcode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Redcode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Redcode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Redcode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Redcode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Redcode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Redcode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Redcode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Redcode ändern",
  ...
  "settings.updates.row.startup.description": "Beim Start von Redcode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Redcode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Redcode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Redcode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Redcode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Redcode reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Redcode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Redcode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Redcode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":

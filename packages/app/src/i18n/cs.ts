...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Redcode",
  ...
  "desktop.recovery.loadFailed": "Redcode se nepodařilo načíst",
  "desktop.recovery.terminated": "Redcode okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Redcode nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "Redcode instalace se nezdařila",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcode aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Redcode.",
  ...
  "dialog.server.description": "Přepněte, ke kterému Redcode serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola Redcode v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace Redcode v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace Redcode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte Redcode do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Redcode může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Redcode nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Redcode.",
  ...
  "help.tabs.introduction": "Redcode Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Redcode ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Redcode",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Redcode zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Redcode uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Redcode",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Redcode na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Redcode následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Redcode.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Redcode",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Redcode.",

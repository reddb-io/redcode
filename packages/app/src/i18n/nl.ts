...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Redcode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Redcode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Redcode reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Redcode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Redcode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Redcode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Redcode te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Redcode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Redcode te gebruiken.",
  ...
  "mcp.auth.browserBlocked.title": "{{name}} autoriseren",
  "mcp.auth.browserBlocked.description": "Kon geen browser openen. Open deze URL om te autoriseren: {{url}}",
  "mcp.auth.browserBlocked.open": "URL openen",
  "mcp.auth.browserBlocked.copy": "URL kopiëren",
  ...
  "dialog.server.description": "Wijzig met welke Redcode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Redcode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Redcode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Redcode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Redcode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Redcode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Redcode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Redcode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Redcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Redcode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Redcode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Redcode opnieuw.",
  ...
  "help.tabs.introduction": "Redcode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Redcode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Redcode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Redcode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Redcode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Redcode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Redcode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Redcode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Redcode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Redcode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Redcode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Redcode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Redcode.",

...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Redcode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Redcode tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Redcode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Redcode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Redcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Redcode.",
  ...
  "dialog.server.description": "Ganti server Redcode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Redcode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Redcode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Redcode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Redcode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Redcode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Redcode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Redcode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Redcode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Redcode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Redcode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Redcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Redcode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Redcode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Redcode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Redcode.",

...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Redcode įkelti nepavyko",
  "Redcode langas netikėtai užsidarė",
  "Redcode neatsako",
  ...
  "Redcode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Redcode neįdiegtas distributyve {{distro}}",
  "Redcode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Redcode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Autorizuoti {{name}}",
  "mcp.auth.browserBlocked.description":
    "Nepavyko atidaryti naršyklės. Norėdami autorizuoti, atidarykite šį URL: {{url}}",
  "mcp.auth.browserBlocked.open": "Atidaryti URL",
  "mcp.auth.browserBlocked.copy": "Kopijuoti URL",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Redcode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Redcode {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Redcode {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Redcode {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Redcode į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Redcode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Redcode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Redcode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Redcode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Redcode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Redcode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Redcode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Redcode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Redcode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Redcode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Redcode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Redcode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Redcode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Redcode versiją.",

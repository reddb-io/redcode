...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode kunde inte läsas in",
  "desktop.recovery.terminated": "Redcode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Redcode svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Redcode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Redcode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Redcode.",
  ...
  "dialog.server.description": "Växla vilken Redcode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Redcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Redcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Redcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Redcode i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Redcode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Redcode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Redcode igen.",
  ...
  "help.tabs.introduction": "Redcode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Redcode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Redcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Redcode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Redcode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Redcode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Redcode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Redcode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Redcode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Redcodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Redcode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Redcode.",

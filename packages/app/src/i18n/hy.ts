...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Redcode մենյու",
  ...
  "desktop.recovery.loadFailed": "Redcode չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Redcode պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Redcode-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Redcode տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcode թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Redcode",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Redcode-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Redcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Redcode-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "mcp.auth.browserBlocked.title": "Թույլատրել {{name}}-ը",
  "mcp.auth.browserBlocked.description": "Չհաջողվեց բացել դիտարկիչը։ Թույլատրելու համար բացեք այս URL-ը՝ {{url}}",
  "mcp.auth.browserBlocked.open": "Բացել URL-ը",
  "mcp.auth.browserBlocked.copy": "Պատճենել URL-ը",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Redcode սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Redcode-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Redcode-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Redcode-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Redcode պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Redcode-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Redcode-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Redcode-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Redcode։",
  ...
  "help.tabs.introduction": "Redcode Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Redcode-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Redcode թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Redcode-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Redcode ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Redcode սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Redcode",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Redcode տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Redcode-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Redcode-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Redcode-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Redcode-ի վերջին տարբերակը։",

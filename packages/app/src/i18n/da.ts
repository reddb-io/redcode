...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Redcode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Redcode.",
  ...
  "dialog.server.description": "Skift hvilken Redcode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Redcode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Redcode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Redcode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Redcode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Redcode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Redcode igen.",
  ...
  "toast.update.description": "En ny version af Redcode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Redcode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Redcode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Redcode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Redcode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Redcode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Redcode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Redcode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Redcodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Redcode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Redcode.",
  ...
  "desktop.recovery.loadFailed": "Redcode kunne ikke indlæses",
  "desktop.recovery.terminated": "Redcode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Redcode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Redcode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Redcode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":

...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Redcode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Autorizza {{name}}",
  "mcp.auth.browserBlocked.description": "Impossibile aprire un browser. Apri questo URL per autorizzare: {{url}}",
  "mcp.auth.browserBlocked.open": "Apri URL",
  "mcp.auth.browserBlocked.copy": "Copia URL",
  ...
  "dialog.server.description": "Cambia il server Redcode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo Redcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento Redcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna Redcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa Redcode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Redcode possa aggiungere un server WSL",
  ...
  "help.tabs.introduction": "Redcode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Redcode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Redcode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Redcode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Redcode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Redcode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Redcode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Redcode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Redcode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Redcode",
  ...
  "settings.updates.toast.latest.title": "Redcode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Redcode.",
  ...
  "desktop.menu.documentation": "Documentazione di Redcode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Redcode",
  "desktop.recovery.terminated": "La finestra di Redcode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Redcode non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di Redcode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Redcode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",

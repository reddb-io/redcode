...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Redcode",
  "desktop.recovery.terminated": "توقفت نافذة Redcode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Redcode لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Redcode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Redcode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "تفويض {{name}}",
  "mcp.auth.browserBlocked.description": "تعذر فتح المتصفح. افتح هذا الرابط للتفويض: {{url}}",
  "mcp.auth.browserBlocked.open": "فتح الرابط",
  "mcp.auth.browserBlocked.copy": "نسخ الرابط",
  ...
  "dialog.server.description": "تبديل خادم Redcode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Redcode في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Redcode في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Redcode في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Redcode في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Redcode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Redcode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Redcode.",
  ...
  "help.tabs.introduction": "أصبح Redcode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Redcode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Redcode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Redcode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Redcode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Redcode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Redcode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Redcode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Redcode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Redcode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Redcode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Redcode.",

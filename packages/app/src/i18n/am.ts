...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode መጫን አልቻለም",
  "desktop.recovery.terminated": "Redcode መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Redcode ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Redcodeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Redcode ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በRedcode",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በRedcode ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በRedcode ይጠቀሙ።",
  ...
  "mcp.auth.browserBlocked.title": "{{name}}ን ፍቀድ",
  "mcp.auth.browserBlocked.description": "አሳሽ መክፈት አልተቻለም። ለመፍቀድ ይህን URL ይክፈቱ፦ {{url}}",
  "mcp.auth.browserBlocked.open": "URL ክፈት",
  "mcp.auth.browserBlocked.copy": "URL ቅዳ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Redcode አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Redcodeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Redcode በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Redcode በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Redcode ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Redcode በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcodeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Redcode WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Redcode በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Redcode።",
  ...
  "help.tabs.introduction": "Redcode ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የRedcode ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለRedcode ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Redcode እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Redcode ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Redcode ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የRedcode አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለRedcode",
  ...
  "settings.general.row.appearance.description": "Redcodeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Redcode ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Redcode ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Redcode ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የRedcode እትም እያሄዱ ነው።",

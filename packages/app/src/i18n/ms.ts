...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Redcode",
  ...
  "desktop.recovery.loadFailed": "Redcode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Redcode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Redcode tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Redcode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Redcode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Redcode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Benarkan {{name}}",
  "mcp.auth.browserBlocked.description": "Tidak dapat membuka pelayar. Buka URL ini untuk membenarkan: {{url}}",
  ...
  "dialog.server.description": "Tukar pelayan Redcode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Redcode dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Redcode dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Redcode dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Redcode dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Redcode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Redcode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Redcode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Redcode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Redcode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Redcode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Redcode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Redcode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Redcode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Redcode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Redcode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Redcode.",

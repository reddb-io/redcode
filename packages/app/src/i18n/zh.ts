...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode 加载失败",
  "desktop.recovery.terminated": "Redcode 窗口意外终止",
  "desktop.recovery.unresponsive": "Redcode 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Redcode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Redcode",
  "desktop.wsl.error.updateVersion":
    "Redcode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Redcode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Redcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Redcode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Redcode 中使用 {{provider}} 模型。",
  ...
  "mcp.auth.browserBlocked.title": "授权 {{name}}",
  "mcp.auth.browserBlocked.description": "无法打开浏览器。请打开此 URL 进行授权：{{url}}",
  "mcp.auth.browserBlocked.open": "打开 URL",
  "mcp.auth.browserBlocked.copy": "复制 URL",
  ...
  "dialog.server.description": "切换此应用连接的 Redcode 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Redcode...",
  "wsl.onboarding.updatingOpencode": "正在更新 Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Redcode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Redcode。",
  "wsl.onboarding.updateOpencode": "更新 Redcode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Redcode 已就绪。",
  "wsl.onboarding.opencodeReady": "Redcode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Redcode。",
  "wsl.onboarding.installOpencode": "安装 Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Redcode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Redcode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Redcode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Redcode。",
  ...
  "help.tabs.introduction": "Redcode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Redcode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Redcode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Redcode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Redcode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Redcode 服务器。",
  ...
  "settings.general.row.appearance.description": "自定义 Redcode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Redcode 跟随系统、浅色或深色主题",
  ...
  "settings.updates.row.startup.description": "在 Redcode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Redcode。",

...
export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Redcode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Redcode",
  "desktop.recovery.terminated": "Okno Redcode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Redcode nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Redcode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Redcode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Redcode.",
  ...
  "dialog.server.description": "Przełącz serwer Redcode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Redcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Redcode w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Redcode w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Redcode w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Redcode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Redcode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Redcode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Redcode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Redcode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Redcode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Redcode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Redcode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Redcode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Redcode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Redcode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Redcode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Redcode.",

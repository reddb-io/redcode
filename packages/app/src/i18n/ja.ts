...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcodeを読み込めませんでした",
  "desktop.recovery.terminated": "Redcodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Redcodeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Redcodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはRedcodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Redcodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Redcodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Redcodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してRedcodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Redcodeで{{provider}}モデルを使用してください。",
  ...
  "mcp.auth.browserBlocked.title": "{{name}} を認可",
  "mcp.auth.browserBlocked.description": "ブラウザを開けませんでした。認可するにはこの URL を開いてください: {{url}}",
  "mcp.auth.browserBlocked.open": "URL を開く",
  "mcp.auth.browserBlocked.copy": "URL をコピー",
  ...
  "dialog.server.description": "このアプリが接続するRedcodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Redcodeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のRedcodeを確認中...",
  "wsl.onboarding.updatingOpencode": "Redcodeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のRedcodeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のRedcodeを更新してください。",
  "wsl.onboarding.updateOpencode": "Redcodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のRedcodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "Redcodeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にRedcodeをインストールしてください。",
  "wsl.onboarding.installOpencode": "Redcodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "RedcodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Redcodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Redcode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Redcodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをRedcodeチームに報告してください: ",
  ...
  "sidebar.gettingStarted.line1": "Redcodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でRedcodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Redcodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのRedcodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Redcodeがシステム、ライト、またはダークテーマに従うかを選択します",
  ...
  "settings.updates.row.startup.description": "Redcode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Redcode は最新バージョンです。",

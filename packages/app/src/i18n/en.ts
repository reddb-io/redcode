...
export const dict = {
  ...
  "intelligence.revision.note": "↻ revised by S1",
  "intelligence.revision.noteIssues": "↻ revised by S1 — {{issues}}",
  "intelligence.revision.showOriginal": "show original",
  "intelligence.revision.hideOriginal": "hide original",
  "intelligence.revision.revising": "↻ Revising the answer after S1 review…",
  "intelligence.revision.confidence": "S1: {{percent}}% sure the answer {{reason}}",
  ...
  "settings.intelligence.operation.prompt_classification": "Prompt classification",
  "settings.intelligence.operation.response_quality": "Response quality",
  "settings.intelligence.operation.task_quality": "Task quality",
  ...
  "settings.intelligence.operation.goal_command": "Goal command",
  ...
  "settings.intelligence.recommended": "Recommended",
  "settings.intelligence.recommendedModel": "Recommended: {{name}} · via RedRouter » {{provider}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Redcode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Redcode.",
  ...
  "dialog.server.description": "Switch which Redcode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Redcode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Redcode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Redcode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Redcode in {{distro}}.",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Redcode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Redcode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Redcode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Redcode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Redcode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Redcode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Redcode server inside WSL on Windows.",
  ...
  "settings.general.row.appearance.description": "Customise how Redcode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Redcode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Redcode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Redcode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Redcode.",

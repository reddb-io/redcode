...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Redcode",
  ...
  "desktop.menu.ariaLabel": "Menú de Redcode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Redcode",
  "desktop.recovery.terminated": "La ventana de Redcode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Redcode no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Redcode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Redcode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Redcode.",
  ...
  "dialog.server.description": "Cambiar el servidor de Redcode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Redcode en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Redcode en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Redcode en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Redcode en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Redcode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Redcode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Redcode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Redcode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Redcode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Redcode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Redcode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Redcode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Redcode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Redcode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Redcode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Redcode.",

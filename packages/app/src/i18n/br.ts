...
export const dict = {
  ...
  "intelligence.revision.note": "↻ revisada pelo S1",
  "intelligence.revision.noteIssues": "↻ revisada pelo S1 — {{issues}}",
  "intelligence.revision.showOriginal": "mostrar original",
  "intelligence.revision.hideOriginal": "ocultar original",
  "intelligence.revision.revising": "↻ Revisando a resposta após a revisão do S1…",
  "intelligence.revision.confidence": "S1: {{percent}}% de certeza de que a resposta {{reason}}",
  ...
  "settings.intelligence.operation.goal_command": "Comando de objetivo",
  ...
  "desktop.menu.documentation": "Documentação do Redcode",
  ...
  "desktop.menu.ariaLabel": "Menu do Redcode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Redcode",
  "desktop.recovery.terminated": "A janela do Redcode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Redcode não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Redcode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Redcode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "command.session.goal.description": "Give this session a definition of done and pursue it until it holds",
  "command.session.goal.pause": "Pause goal",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Redcode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Redcode.",
  ...
  "mcp.auth.browserBlocked.description": "Não foi possível abrir um navegador. Abra esta URL para autorizar: {{url}}",
  ...
  "dialog.server.description": "Trocar para qual servidor Redcode este aplicativo se conecta.",
  ...
  "wsl.onboarding.step.opencode": "Redcode",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Redcode em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Redcode em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Redcode em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Redcode",
  "wsl.onboarding.opencodeReadyIn": "O Redcode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Redcode está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Redcode em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Redcode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Redcode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Redcode novamente.",
  ...
  "help.tabs.introduction": "Agora, o Redcode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Redcode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Redcode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Redcode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "app.name.desktop": "Redcode Desktop",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Redcode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Redcode",
  ...
  "settings.general.row.appearance.description": "Personalize como o Redcode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Redcode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Redcode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Redcode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Redcode.",

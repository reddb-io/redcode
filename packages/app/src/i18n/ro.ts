...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Redcode",
  ...
  "desktop.menu.ariaLabel": "Meniu Redcode",
  ...
  "desktop.recovery.loadFailed": "Redcode nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Redcode s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Redcode nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea Redcode a eșuat",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Redcode s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Redcode",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Redcode.",
  ...
  "dialog.server.description": "Schimbă serverul Redcode la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică Redcode în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează Redcode în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează Redcode în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează Redcode în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Redcode să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Redcode nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Redcode ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Redcode",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Redcode nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Redcode în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Redcode",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Redcode pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Redcode urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Redcode.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Redcode",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Redcode.",

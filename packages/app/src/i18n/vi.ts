...
export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Redcode",
  ...
  "desktop.recovery.loadFailed": "Không tải được Redcode",
  "desktop.recovery.terminated": "Cửa sổ Redcode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Redcode không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Redcode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Redcode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Ủy quyền {{name}}",
  "mcp.auth.browserBlocked.description": "Không thể mở trình duyệt. Mở URL này để ủy quyền: {{url}}",
  "mcp.auth.browserBlocked.open": "Mở URL",
  "mcp.auth.browserBlocked.copy": "Sao chép URL",
  ...
  "dialog.server.description": "Chuyển máy chủ Redcode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Redcode trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Redcode trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Redcode trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Redcode trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Redcode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Redcode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Redcode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Redcode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Redcode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Redcode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Redcode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Redcode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Redcode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Redcode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Redcode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Redcode.",

...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Redcode se nije uspio učitati",
  "Prozor aplikacije Redcode neočekivano je zatvoren",
  "Redcode ne reagira",
  ...
  "Instalacija aplikacije Redcode nije uspjela",
  ...
  "Redcode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Redcode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Redcode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Autoriziraj {{name}}",
  ...
  "dialog.server.description": "Promijenite na koji se Redcode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Redcode u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Redcode u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Redcode u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Redcode u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Redcode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Redcode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Redcode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Redcode.",
  ...
  "help.tabs.introduction": "Radna površina Redcode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Redcode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Redcode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Redcode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Redcode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Redcode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Redcode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Redcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Redcode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Redcode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Redcode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Redcode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Redcode.",

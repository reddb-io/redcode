...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Redcode meni",
  ...
  "desktop.recovery.loadFailed": "Redcode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Redcode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Redcode se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev Redcode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Redcode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Redcode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Avtoriziraj {{name}}",
  "mcp.auth.browserBlocked.description": "Brskalnika ni bilo mogoče odpreti. Za avtorizacijo odprite ta URL: {{url}}",
  "mcp.auth.browserBlocked.open": "Odpri URL",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Redcode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje Redcode ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje Redcode v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje Redcode ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje Redcode v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite Redcode v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite Redcode v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Redcode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Redcode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Redcode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Redcode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Redcode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Redcode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Redcode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Redcode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Redcode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Redcode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Redcode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Redcode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Redcode.",

...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Redcoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Redcodessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Redcodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Redcodessa.",
  ...
  "mcp.auth.browserBlocked.title": "Valtuuta {{name}}",
  "mcp.auth.browserBlocked.description": "Selainta ei voitu avata. Avaa tämä URL-osoite valtuuttaaksesi: {{url}}",
  "mcp.auth.browserBlocked.open": "Avaa URL",
  "mcp.auth.browserBlocked.copy": "Kopioi URL",
  ...
  "dialog.server.description": "Vaihda Redcode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Redcodea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Redcodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Redcodea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Redcodea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Redcode jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Redcode jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Redcode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Redcode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Redcode uudelleen.",
  ...
  "toast.update.description": "Redcoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Redcode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Redcode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Redcode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Redcode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Redcoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Redcode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Redcode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Redcoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Redcode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Redcoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Redcode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Redcode-valikko",
  ...
  "desktop.recovery.loadFailed": "Redcoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Redcode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Redcode ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Redcoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Redcode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":

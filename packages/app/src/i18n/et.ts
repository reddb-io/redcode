...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Redcode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Redcode ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Redcode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Redcode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Redcode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Redcode'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Redcode.",
  ...
  "mcp.auth.browserBlocked.title": "Autoriseeri {{name}}",
  "mcp.auth.browserBlocked.description": "Brauserit ei õnnestunud avada. Autoriseerimiseks ava see URL: {{url}}",
  "mcp.auth.browserBlocked.open": "Ava URL",
  "mcp.auth.browserBlocked.copy": "Kopeeri URL",
  ...
  "dialog.server.description": "Lülitage, millise Redcode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Redcode kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Redcode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Redcode värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Redcode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Redcode jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Redcode asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Redcode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Redcode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Redcode.",
  ...
  "help.tabs.introduction": "Redcode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Redcode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Redcode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Redcode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Redcode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Redcode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Redcode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Redcode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Redcode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Redcode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Redcode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Redcode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Redcode uusimat versiooni.",

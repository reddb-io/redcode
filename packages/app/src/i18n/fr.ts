...
export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Redcode",
  ...
  "desktop.menu.ariaLabel": "Menu Redcode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Redcode",
  "desktop.recovery.terminated": "La fenêtre Redcode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Redcode ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Redcode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Redcode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Redcode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Redcode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Redcode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Redcode.",
  ...
  "mcp.auth.browserBlocked.description": "Impossible d'ouvrir un navigateur. Ouvrez cette URL pour autoriser : {{url}}",
  "mcp.auth.browserBlocked.open": "Ouvrir l'URL",
  "mcp.auth.browserBlocked.copy": "Copier l'URL",
  ...
  "dialog.server.description": "Changez le serveur Redcode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Redcode...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Redcode dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Redcode...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Redcode dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Redcode dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Redcode",
  "wsl.onboarding.opencodeReadyIn": "Redcode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Redcode est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Redcode dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Redcode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Redcode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Redcode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Redcode.",
  ...
  "help.tabs.introduction": "Redcode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Redcode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Redcode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Redcode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Redcode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Redcode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Redcode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Redcode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Redcode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Redcode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Redcode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Redcode.",

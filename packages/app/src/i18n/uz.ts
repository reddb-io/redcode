...
export const dict = {
  ...
  "desktop.menu.documentation": "Redcode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Redcode menyusi",
  ...
  "desktop.recovery.loadFailed": "Redcode yuklanmadi",
  "desktop.recovery.terminated": "Redcode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Redcode javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "Redcode oʻrnatilmadi",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Redcode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Redcode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Redcode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Redcode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Redcode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Redcode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "Redcode tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "Redcode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "Redcode yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "Redcode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "Redcode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "Redcode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "Redcode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "Redcode tayyor.",
  "wsl.onboarding.installOpencodeIn": "Redcode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "Redcode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Redcode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Redcode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Redcode-ni qayta oching.",
  ...
  "help.tabs.introduction": "Redcode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Redcode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Redcode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Redcode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Redcode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Redcode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Redcode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Redcode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Redcode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Redcode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Redcode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Redcode oxirgi versiyasini ishga tushiryapsiz.",

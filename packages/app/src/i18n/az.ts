...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Redcode yüklənə bilmədi",
  "desktop.recovery.terminated": "Redcode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Redcode cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Redcode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Redcode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Redcode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Redcode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Redcode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Redcode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Redcode-da {{provider}} modellərindən istifadə edin.",
  ...
  "mcp.auth.browserBlocked.title": "{{name}} üçün icazə ver",
  "mcp.auth.browserBlocked.description": "Brauzer açıla bilmədi. İcazə vermək üçün bu URL-i açın: {{url}}",
  "mcp.auth.browserBlocked.open": "URL-i aç",
  "mcp.auth.browserBlocked.copy": "URL-i kopyala",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Redcode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Redcode yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Redcode yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Redcode yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Redcode yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Redcode-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Redcode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Redcode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Redcode hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Redcode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Redcode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Redcode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Redcode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Redcode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Redcode-u yenidən açın.",
  ...
  "help.tabs.introduction": "Redcode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Redcode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Redcode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Redcode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Redcode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Redcode serverini işlət.",
  ...
  "settings.general.row.language.description": "Redcode üçün ekran dilini dəyişdirin",
  ...
  "settings.updates.row.startup.description": "Redcode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Redcode-un ən son versiyasından istifadə edirsiniz.",

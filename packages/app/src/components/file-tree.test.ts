...
beforeAll(async () => {
  ...
  mock.module("@reddb-io/redcode-ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@reddb-io/redcode-ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@reddb-io/redcode-ui/icon", () => ({ Icon: () => null }))
  mock.module("@reddb-io/redcode-ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

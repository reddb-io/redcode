    ...
    HttpApiGroup.make("redskilled")
      .add(
        ...
        HttpApiEndpoint.post("consent", `${root}/consent`, {
          ...
          OpenApi.annotations({ identifier: "redskilled.consent", summary: "Change redskilled consent" }),
        ),
        ...
        HttpApiEndpoint.post("steerStatus", `${root}/worker/steer/status`, {
          ...
          OpenApi.annotations({ identifier: "redskilled.worker.steerStatus", summary: "Read Worker steer status" }),
        ),
      )

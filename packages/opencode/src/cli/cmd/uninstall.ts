...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall redcode and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
  ...
  handler: async (args: UninstallArgs) => {
    ...
    UI.println(UI.logo("  "))
    UI.empty()
    prompts.intro("Uninstall Redcode")
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g @reddb-io/redcode",
      pnpm: "pnpm uninstall -g @reddb-io/redcode",
      bun: "bun remove -g @reddb-io/redcode",
      yarn: "yarn global remove @reddb-io/redcode",
    }
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  UI.empty()
  prompts.log.success("Thank you for using Redcode!")
}

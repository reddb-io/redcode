    ...
    .flatMap((group) =>
      group.endpoints.flatMap((endpoint) => {
        ...
        const success =
          ...
          (resolveHttpApiEncoding(successSchema.ast)?._tag === "Uint8Array"
            ? "Uint8Array"
            : typeOf(

...
@container(max-width:900px){header{gap:6px;padding:8px 12px}h1{margin-right:8px}header select{flex-basis:160px;max-width:200px}#restore{display:none}main{grid-template-columns:minmax(0,1fr) 300px}.canvas{padding:16px}.panel{padding:16px}}

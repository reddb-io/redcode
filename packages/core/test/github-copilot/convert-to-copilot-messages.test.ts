import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@reddb-io/redcode-core/github-copilot/chat/convert-to-openai-compatible-chat-messages"

...
import { OpencodePlugin } from "@reddb-io/redcode-core/plugin/provider/opencode"
...
describe("OpencodePlugin", () => {
  ...
  it.effect("stays unavailable without credentials instead of using the public key", () =>

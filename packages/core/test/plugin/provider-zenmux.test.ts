...
import { ProviderPlugins } from "@reddb-io/redcode-core/plugin/provider"
import { ZenmuxPlugin } from "@reddb-io/redcode-core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/reddb-io/redcode", "X-Title": "redcode" })

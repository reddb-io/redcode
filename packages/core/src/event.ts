...
import { Durable } from "@reddb-io/redcode-schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@reddb-io/redcode-schema/event").ID
export type { Data, Definition, Payload } from "@reddb-io/redcode-schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/Event") {}

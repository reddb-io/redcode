...
import { Entry, FileSystem, FindInput, Match } from "@reddb-io/redcode-schema/filesystem"
export { Entry, Match, Submatch } from "@reddb-io/redcode-schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/v2/FileSystem") {}

...
import { FileSystemWatcher } from "@reddb-io/redcode-schema/filesystem-watcher"
...
declare const REDCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof REDCODE_LIBC === "undefined" ? undefined : REDCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@redcode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.REDCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.REDCODE_EXPERIMENTAL_FILEWATCHER)) {

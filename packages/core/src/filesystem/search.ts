...
export class Service extends Context.Service<Service, Interface>()("@redcode/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.REDCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))

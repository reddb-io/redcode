...
import { PermissionSaved } from "@reddb-io/redcode-schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/v2/PermissionSaved") {}

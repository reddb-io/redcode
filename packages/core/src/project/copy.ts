...
import { Event } from "@reddb-io/redcode-schema/project-directories"
import { ProjectCopy } from "@reddb-io/redcode-schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@redcode/ProjectCopy") {}

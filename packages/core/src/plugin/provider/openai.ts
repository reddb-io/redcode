...
import type { IntegrationOAuthMethodRegistration } from "@reddb-io/redcode-plugin/v2/effect/integration"
import { define } from "@reddb-io/redcode-plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `redcode/${InstallationVersion}` }
}

import { Redcode } from "@reddb-io/redcode-client/effect"
...
import { createEmbeddedRoutes } from "@reddb-io/redcode-server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Redcode.create")(function* () {
  ...
  const client = yield* Redcode.make({ baseUrl: "http://redcode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@reddb-io/redcode-sdk-next/Redcode") {}

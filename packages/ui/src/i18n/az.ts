export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.inconclusive": "qeyri-müəyyən",
  "ui.tool.task.verdict.needs_revision": "düzəliş tələb olunur",
  "ui.tool.task.verdict.unverified": "doğrulanmayıb",
  "ui.tool.task.checkpoint.in_scope": "əhatə daxilində",
  "ui.tool.task.checkpoint.corrected": "düzəldildi (ipucu göndərildi)",
  "ui.tool.task.checkpoint.stopped": "dayandırıldı · {{reason}}",

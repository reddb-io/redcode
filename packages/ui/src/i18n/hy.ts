export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ստուգված",
  "ui.tool.task.verdict.inconclusive": "անորոշ",
  "ui.tool.task.verdict.needs_revision": "վերանայման կարիք ունի",
  "ui.tool.task.verdict.unverified": "չստուգված",
  "ui.tool.task.checkpoint.in_scope": "շրջանակում",
  "ui.tool.task.checkpoint.corrected": "ուղղված (հուշում ուղարկված)",
  "ui.tool.task.checkpoint.stopped": "կանգնեցված · {{reason}}",

export const dict = {
  ...
  "ui.tool.task.verdict.verified": "тасдиқшуда",
  "ui.tool.task.verdict.inconclusive": "номуайян",
  "ui.tool.task.verdict.needs_revision": "ба таҷдиди назар ниёз дорад",
  "ui.tool.task.verdict.unverified": "тасдиқнашуда",
  "ui.tool.task.checkpoint.in_scope": "дар доира",
  "ui.tool.task.checkpoint.corrected": "ислоҳ шуд (ишора фиристода шуд)",
  "ui.tool.task.checkpoint.stopped": "қатъ шуд · {{reason}}",

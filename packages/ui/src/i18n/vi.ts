export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "đã xác minh",
  "ui.tool.task.verdict.inconclusive": "không kết luận được",
  "ui.tool.task.verdict.needs_revision": "cần sửa đổi",
  "ui.tool.task.verdict.unverified": "chưa xác minh",
  "ui.tool.task.checkpoint.in_scope": "trong phạm vi",
  "ui.tool.task.checkpoint.corrected": "đã chỉnh (đã gửi gợi ý)",
  "ui.tool.task.checkpoint.stopped": "đã dừng · {{reason}}",

export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "επαληθεύτηκε",
  "ui.tool.task.verdict.inconclusive": "ασαφές",
  "ui.tool.task.verdict.needs_revision": "χρειάζεται αναθεώρηση",
  "ui.tool.task.verdict.unverified": "μη επαληθευμένο",
  "ui.tool.task.checkpoint.in_scope": "εντός εύρους",
  "ui.tool.task.checkpoint.corrected": "διορθώθηκε (στάλθηκε υπόδειξη)",
  "ui.tool.task.checkpoint.stopped": "διακόπηκε · {{reason}}",

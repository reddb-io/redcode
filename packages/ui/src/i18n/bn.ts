export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "OpenCode Go-এ সদস্যতা নিন $5/মাস থেকে শুরু করে সেরা ওপেন-সোর্স মডেলগুলিতে নির্ভরযোগ্য অ্যাক্সেসের জন্য যান৷",
  ...
  "ui.tool.task.verdict.verified": "যাচাই করা হয়েছে",
  "ui.tool.task.verdict.inconclusive": "অনিশ্চিত",
  "ui.tool.task.verdict.needs_revision": "সংশোধন প্রয়োজন",
  "ui.tool.task.verdict.unverified": "যাচাই করা হয়নি",
  "ui.tool.task.checkpoint.in_scope": "পরিধির মধ্যে",
  "ui.tool.task.checkpoint.corrected": "সংশোধিত (ইঙ্গিত পাঠানো হয়েছে)",
  "ui.tool.task.checkpoint.stopped": "থামানো হয়েছে · {{reason}}",

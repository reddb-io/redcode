export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.inconclusive": "no concloent",
  "ui.tool.task.verdict.needs_revision": "cal revisar",
  "ui.tool.task.verdict.unverified": "no verificat",
  "ui.tool.task.checkpoint.in_scope": "dins l'abast",
  "ui.tool.task.checkpoint.corrected": "corregit (pista enviada)",
  "ui.tool.task.checkpoint.stopped": "aturat · {{reason}}",

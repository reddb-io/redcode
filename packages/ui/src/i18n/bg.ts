export const dict = {
  ...
  "ui.tool.task.verdict.verified": "потвърдено",
  "ui.tool.task.verdict.inconclusive": "неубедително",
  "ui.tool.task.verdict.needs_revision": "нужда от преработка",
  "ui.tool.task.verdict.unverified": "непотвърдено",
  "ui.tool.task.checkpoint.in_scope": "в обхвата",
  "ui.tool.task.checkpoint.corrected": "коригирано (изпратена подсказка)",
  "ui.tool.task.checkpoint.stopped": "спряно · {{reason}}",

export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ਪ੍ਰਮਾਣਿਤ",
  "ui.tool.task.verdict.inconclusive": "ਅਨਿਸ਼ਚਿਤ",
  "ui.tool.task.verdict.needs_revision": "ਸੋਧ ਦੀ ਲੋੜ",
  "ui.tool.task.verdict.unverified": "ਅਪ੍ਰਮਾਣਿਤ",
  "ui.tool.task.checkpoint.in_scope": "ਦਾਇਰੇ ਵਿੱਚ",
  "ui.tool.task.checkpoint.corrected": "ਸੁਧਾਰਿਆ ਗਿਆ (ਸੰਕੇਤ ਭੇਜਿਆ)",
  "ui.tool.task.checkpoint.stopped": "ਰੋਕਿਆ ਗਿਆ · {{reason}}",
  "ui.tool.skill": "Skill",

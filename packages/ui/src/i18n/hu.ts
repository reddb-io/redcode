export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ellenőrizve",
  "ui.tool.task.verdict.inconclusive": "nem egyértelmű",
  "ui.tool.task.verdict.needs_revision": "átdolgozásra szorul",
  "ui.tool.task.verdict.unverified": "nincs ellenőrizve",
  "ui.tool.task.checkpoint.in_scope": "a hatókörön belül",
  "ui.tool.task.checkpoint.corrected": "javítva (tipp elküldve)",
  "ui.tool.task.checkpoint.stopped": "leállítva · {{reason}}",

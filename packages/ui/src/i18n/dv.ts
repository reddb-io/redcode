export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ތަހުގީގުކުރެވިއްޖެ",
  "ui.tool.task.verdict.inconclusive": "ނިންމުމެއް ނުވޭ",
  "ui.tool.task.verdict.needs_revision": "މުރާޖަޢާ ކުރަން ޖެހޭ",
  "ui.tool.task.verdict.unverified": "ތަހުގީގު ނުކުރެވޭ",
  "ui.tool.task.checkpoint.in_scope": "ދާއިރާގެ ތެރޭގައި",
  "ui.tool.task.checkpoint.corrected": "ރަނގަޅުކުރެވިއްޖެ (އިޝާރާތެއް ފޮނުވިއްޖެ)",
  "ui.tool.task.checkpoint.stopped": "ހުއްޓުވިއްޖެ · {{reason}}",

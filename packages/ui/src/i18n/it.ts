export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "verificato",
  "ui.tool.task.verdict.inconclusive": "non conclusivo",
  "ui.tool.task.verdict.needs_revision": "da rivedere",
  "ui.tool.task.verdict.unverified": "non verificato",
  "ui.tool.task.checkpoint.in_scope": "nell'ambito",
  "ui.tool.task.checkpoint.corrected": "corretto (suggerimento inviato)",
  "ui.tool.task.checkpoint.stopped": "interrotto · {{reason}}",
  "ui.tool.skill": "Skill",

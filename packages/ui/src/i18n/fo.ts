export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "váttað",
  "ui.tool.task.verdict.inconclusive": "óavgjørt",
  "ui.tool.task.verdict.needs_revision": "tørvur á endurskoðan",
  "ui.tool.task.verdict.unverified": "ikki váttað",
  "ui.tool.task.checkpoint.in_scope": "innan fyri økið",
  "ui.tool.task.checkpoint.corrected": "rættað (vísbending send)",
  "ui.tool.task.checkpoint.stopped": "steðgað · {{reason}}",

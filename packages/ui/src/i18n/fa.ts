export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "تأیید شد",
  "ui.tool.task.verdict.inconclusive": "نامشخص",
  "ui.tool.task.verdict.needs_revision": "نیاز به بازبینی",
  "ui.tool.task.verdict.unverified": "تأییدنشده",
  "ui.tool.task.checkpoint.in_scope": "در محدوده",
  "ui.tool.task.checkpoint.corrected": "اصلاح شد (راهنما ارسال شد)",
  "ui.tool.task.checkpoint.stopped": "متوقف شد · {{reason}}",
  "ui.tool.skill": "مهارت",

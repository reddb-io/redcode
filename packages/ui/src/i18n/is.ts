export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "staðfest",
  "ui.tool.task.verdict.inconclusive": "óljóst",
  "ui.tool.task.verdict.needs_revision": "þarfnast endurskoðunar",
  "ui.tool.task.verdict.unverified": "óstaðfest",
  "ui.tool.task.checkpoint.in_scope": "innan umfangs",
  "ui.tool.task.checkpoint.corrected": "leiðrétt (vísbending send)",
  "ui.tool.task.checkpoint.stopped": "stöðvað · {{reason}}",
  "ui.tool.skill": "Færni",

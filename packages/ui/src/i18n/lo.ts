export const dict = {
  ...
  "ui.tool.task.verdict.verified": "ຢືນຢັນແລ້ວ",
  "ui.tool.task.verdict.inconclusive": "ບໍ່ແນ່ນອນ",
  "ui.tool.task.verdict.needs_revision": "ຕ້ອງປັບປຸງ",
  "ui.tool.task.verdict.unverified": "ຍັງບໍ່ໄດ້ຢືນຢັນ",
  "ui.tool.task.checkpoint.in_scope": "ຢູ່ໃນຂອບເຂດ",
  "ui.tool.task.checkpoint.corrected": "ແກ້ໄຂແລ້ວ (ສົ່ງຄຳແນະນຳແລ້ວ)",
  "ui.tool.task.checkpoint.stopped": "ຢຸດແລ້ວ · {{reason}}",
  "ui.tool.skill": "ທັກສະ",

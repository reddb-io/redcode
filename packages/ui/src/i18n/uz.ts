export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "tasdiqlangan",
  "ui.tool.task.verdict.inconclusive": "noaniq",
  "ui.tool.task.verdict.needs_revision": "qayta koʻrib chiqish kerak",
  "ui.tool.task.verdict.unverified": "tasdiqlanmagan",
  "ui.tool.task.checkpoint.in_scope": "doira ichida",
  "ui.tool.task.checkpoint.corrected": "tuzatildi (maslahat yuborildi)",
  "ui.tool.task.checkpoint.stopped": "toʻxtatildi · {{reason}}",

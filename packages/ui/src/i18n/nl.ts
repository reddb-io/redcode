export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "geverifieerd",
  "ui.tool.task.verdict.inconclusive": "niet doorslaggevend",
  "ui.tool.task.verdict.needs_revision": "herziening nodig",
  "ui.tool.task.verdict.unverified": "niet geverifieerd",
  "ui.tool.task.checkpoint.in_scope": "binnen bereik",
  "ui.tool.task.checkpoint.corrected": "gecorrigeerd (hint verzonden)",
  "ui.tool.task.checkpoint.stopped": "gestopt · {{reason}}",

export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ተረጋግጧል",
  "ui.tool.task.verdict.inconclusive": "የማያሳምን",
  "ui.tool.task.verdict.needs_revision": "ክለሳ ያስፈልገዋል",
  "ui.tool.task.verdict.unverified": "ያልተረጋገጠ",
  "ui.tool.task.checkpoint.in_scope": "በወሰን ውስጥ",
  "ui.tool.task.checkpoint.corrected": "ተስተካክሏል (ፍንጭ ተልኳል)",
  "ui.tool.task.checkpoint.stopped": "ቆሟል · {{reason}}",
  "ui.tool.skill": "ክህሎት",

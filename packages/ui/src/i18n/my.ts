export const dict = {
  ...
  "ui.tool.task.verdict.verified": "အတည်ပြုပြီး",
  "ui.tool.task.verdict.inconclusive": "မသေချာ",
  "ui.tool.task.verdict.needs_revision": "ပြန်လည်ပြင်ဆင်ရန်လိုသည်",
  "ui.tool.task.verdict.unverified": "အတည်မပြုရသေး",
  "ui.tool.task.checkpoint.in_scope": "နယ်ပယ်အတွင်း",
  "ui.tool.task.checkpoint.corrected": "ပြင်ဆင်ပြီး (အရိပ်အမြွက်ပို့ပြီး)",
  "ui.tool.task.checkpoint.stopped": "ရပ်တန့်ထားသည် · {{reason}}",

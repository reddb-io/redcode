export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "ověřeno",
  "ui.tool.task.verdict.inconclusive": "neprůkazné",
  "ui.tool.task.verdict.needs_revision": "vyžaduje revizi",
  "ui.tool.task.verdict.unverified": "neověřeno",
  "ui.tool.task.checkpoint.in_scope": "v rozsahu",
  "ui.tool.task.checkpoint.corrected": "opraveno (odeslána nápověda)",
  "ui.tool.task.checkpoint.stopped": "zastaveno · {{reason}}",

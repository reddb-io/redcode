export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "تصدیق شدہ",
  "ui.tool.task.verdict.inconclusive": "غیر حتمی",
  "ui.tool.task.verdict.needs_revision": "نظرثانی درکار",
  "ui.tool.task.verdict.unverified": "غیر تصدیق شدہ",
  "ui.tool.task.checkpoint.in_scope": "دائرہ کار میں",
  "ui.tool.task.checkpoint.corrected": "درست کیا گیا (اشارہ بھیجا گیا)",
  "ui.tool.task.checkpoint.stopped": "روک دیا گیا · {{reason}}",
  "ui.tool.skill": "مہارت",

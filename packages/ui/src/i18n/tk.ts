export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "tassyklandy",
  "ui.tool.task.verdict.inconclusive": "anyk däl",
  "ui.tool.task.verdict.needs_revision": "gözden geçirmek gerek",
  "ui.tool.task.verdict.unverified": "tassyklanmadyk",
  "ui.tool.task.checkpoint.in_scope": "çäginde",
  "ui.tool.task.checkpoint.corrected": "düzedildi (maslahat iberildi)",
  "ui.tool.task.checkpoint.stopped": "saklandy · {{reason}}",

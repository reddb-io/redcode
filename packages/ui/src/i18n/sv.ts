export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "verifierad",
  "ui.tool.task.verdict.inconclusive": "ej avgörande",
  "ui.tool.task.verdict.needs_revision": "behöver revideras",
  "ui.tool.task.verdict.unverified": "ej verifierad",
  "ui.tool.task.checkpoint.in_scope": "inom omfånget",
  "ui.tool.task.checkpoint.corrected": "korrigerad (tips skickat)",
  "ui.tool.task.checkpoint.stopped": "stoppad · {{reason}}",

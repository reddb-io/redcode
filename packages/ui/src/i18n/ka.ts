export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "დადასტურებული",
  "ui.tool.task.verdict.inconclusive": "გაურკვეველი",
  "ui.tool.task.verdict.needs_revision": "საჭიროებს გადახედვას",
  "ui.tool.task.verdict.unverified": "დაუდასტურებელი",
  "ui.tool.task.checkpoint.in_scope": "ფარგლებში",
  "ui.tool.task.checkpoint.corrected": "შესწორებული (მინიშნება გაიგზავნა)",
  "ui.tool.task.checkpoint.stopped": "შეჩერებული · {{reason}}",
  "ui.tool.skill": "უნარი",

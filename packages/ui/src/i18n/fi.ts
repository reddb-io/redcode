export const dict: Record<string, string> = {
  ...
  "ui.tool.task.verdict.verified": "vahvistettu",
  "ui.tool.task.verdict.inconclusive": "epäselvä",
  "ui.tool.task.verdict.needs_revision": "vaatii korjausta",
  "ui.tool.task.verdict.unverified": "vahvistamaton",
  "ui.tool.task.checkpoint.in_scope": "rajauksen sisällä",
  "ui.tool.task.checkpoint.corrected": "korjattu (vihje lähetetty)",
  "ui.tool.task.checkpoint.stopped": "pysäytetty · {{reason}}",
  "ui.tool.skill": "Taito",

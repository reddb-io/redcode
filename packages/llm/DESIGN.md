...
> current private `@reddb-io/redcode-llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@reddb-io/redcode-ai`
...
import { LLM } from "@reddb-io/redcode-ai"
import { OpenAI } from "@reddb-io/redcode-ai/providers/openai"
...
```ts
import { Message } from "@reddb-io/redcode-ai"
...
import { LLM, Tool } from "@reddb-io/redcode-ai"
...
```ts
import { LLM } from "@reddb-io/redcode-ai/promise"
import { OpenAI } from "@reddb-io/redcode-ai/providers/openai"
...
```ts
import { LLMSchema } from "@reddb-io/redcode-ai/schema"
...
```ts
import { Provider, Protocol } from "@reddb-io/redcode-ai/provider"
...
@reddb-io/redcode-ai/promise
  Promise/AsyncIterable LLM facade

@reddb-io/redcode-ai/schema
  serializable domain schemas

@reddb-io/redcode-ai/provider
  experimental Provider and Protocol authoring APIs

@reddb-io/redcode-ai/providers/openai
@reddb-io/redcode-ai/providers/anthropic
@reddb-io/redcode-ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@reddb-io/redcode-llm`                      | `@reddb-io/redcode-ai`                                           |

...
export const Definitions = {
  ...
  "dialog.mcp.reload": keybind("ctrl+r", "Reload MCP in MCP dialog"),
  "dialog.mcp.authenticate": keybind("ctrl+a", "Authenticate MCP in MCP dialog"),
...
export const CommandMap = {
  ...
  sidebar_tab_cycle: "session.sidebar.tab.cycle",

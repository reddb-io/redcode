# Remove `packages/redcode/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/redcode/src/storage/db.ts` module.
...
Production imports from `packages/redcode/src/storage/db.ts` are concentrated in 22 source files:

- `packages/redcode/src/account/repo.ts`
- `packages/redcode/src/cli/cmd/db.ts`
- `packages/redcode/src/cli/cmd/import.ts`
- `packages/redcode/src/cli/cmd/stats.ts`
- `packages/redcode/src/control-plane/workspace.ts`
- `packages/redcode/src/index.ts`
- `packages/redcode/src/node.ts`
- `packages/redcode/src/permission/index.ts`
- `packages/redcode/src/project/project.ts`
- `packages/redcode/src/server/projectors.ts`
- `packages/redcode/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/redcode/src/server/shared/fence.ts`
- `packages/redcode/src/session/message-v2.ts`
- `packages/redcode/src/session/projectors.ts`
- `packages/redcode/src/session/prompt.ts`
- `packages/redcode/src/session/session.ts`
- `packages/redcode/src/session/todo.ts`
- `packages/redcode/src/share/share-next.ts`
- `packages/redcode/src/storage/db.ts`
- `packages/redcode/src/sync/index.ts`
- `packages/redcode/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/redcode/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/redcode/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/redcode`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/redcode/src`
- `bun typecheck` from `packages/redcode`
- Relevant package tests from `packages/redcode`, not the repo root
